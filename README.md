...
```bash
npx skills add marcincept-svg/my-agent-skills --skill skillname
# or add all skills from the repo
npx skills add marcincept-svg/my-agent-skills
```
...
```bash
git clone git@github.com:marcincept-svg/my-agent-skills.git ~/temp-skills
```
